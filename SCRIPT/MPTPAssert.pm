...
# sub GASSERTION () { ASSERTION_ALL }
# sub GASSERTION () { ASSERTION_FILTER }
# sub GASSERTION () { ASSERTION_GENERAL }
 sub GASSERTION () { ASSERTION_NONE }
# sub GASSERTION () { ASSERTION_BADREFS }
