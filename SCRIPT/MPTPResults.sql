...
/* used_input_flas_nr = used_dir_refs_nr + used_bg_flas_nr */
  ...
  used_input_flas	TEXT,			/* List of their names */
  used_dir_refs_nr	INT UNSIGNED,
  used_dir_refs	TEXT,			/* List of their names */
  used_bg_flas_nr	INT UNSIGNED,
  used_bg_flas		TEXT,			/* List of their names */

/* not yet */
--  used_syms_nr		INT UNSIGNED,
--  used_syms		TEXT,			/* Only if in the proof */
...
/* id is common with the proved table */
  ...
  proof			MEDIUMTEXT,	/* About 17M should be enough */
  PRIMARY KEY ( id )
);
